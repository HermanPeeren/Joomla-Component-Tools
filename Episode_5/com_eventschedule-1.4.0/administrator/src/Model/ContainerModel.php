...
class ContainerModel extends AdminModel
{
	 ...
	 * @since   1.4.0
	 */
	public function getTable($type = 'Container', $prefix = 'Administrator', $config = array())
	{
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_eventschedule.edit.container.data', array());
	...
	/**
	 * Method to duplicate an Container
	 *
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = $this->getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__eventschedule_containers');
				$max             = $db->loadResult();
