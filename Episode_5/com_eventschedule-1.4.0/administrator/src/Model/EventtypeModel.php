...
class EventtypeModel extends AdminModel
{
	 ...
	 * @since  1.4.0
	 */
	public $typeAlias = 'com_eventschedule.eventtype';
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_eventschedule.edit.eventtype.data', array());
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = $this->getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__eventschedule_event_types');
				$max             = $db->loadResult();
