 ...
 * @since 1.4.0
 */
class ContainerTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!$user->authorise('core.admin', 'com_eventschedule.container.' . $array['id']))
		{
			$actions         = Access::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_eventschedule/access.xml',
				"/access/section[@name='container']/"
			);
			$default_actions = Access::getAssetRules('com_eventschedule.container.' . $array['id'])->getData();
			$array_jaccess   = array();
