...
class EventtypeTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!$user->authorise('core.admin', 'com_eventschedule.eventtype.' . $array['id']))
		{
			$actions         = Access::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_eventschedule/access.xml',
				"/access/section[@name='eventtype']/"
			);
			$default_actions = Access::getAssetRules('com_eventschedule.eventtype.' . $array['id'])->getData();
			$array_jaccess   = array();
