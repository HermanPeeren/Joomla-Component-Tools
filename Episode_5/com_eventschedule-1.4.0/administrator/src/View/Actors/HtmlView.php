...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_EVENTSCHEDULE_TITLE_ACTORS'), "jcc fa-person");

		$toolbar = Toolbar::getInstance('toolbar');

		// Check if the form exists before showing the add/edit buttons
		$formPath = JPATH_COMPONENT_ADMINISTRATOR . '/src/View/Actors';
		...
		// Set sidebar action
		Sidebar::setAction('index.php?option=com_eventschedule&view=actors');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`actor_name`' => Text::_('COM_EVENTSCHEDULE_ACTORS_ACTOR_NAME'),
			'a.`events`' => Text::_('COM_EVENTSCHEDULE_ACTORS_EVENTS'),
			'a.`schedule`' => Text::_('COM_EVENTSCHEDULE_ACTORS_SCHEDULE'),
		);
	}
