...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_EVENTSCHEDULE_TITLE_EVENTTYPES'), "jcc fa-calendar-check");
		...
		if (isset($this->items[0]->state))
		{
			...
			{
				$toolbar->delete('eventtypes.delete')
		...
		// Set sidebar action
		Sidebar::setAction('index.php?option=com_eventschedule&view=eventtypes');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`event_type_name`' => Text::_('COM_EVENTSCHEDULE_EVENTTYPES_EVENT_TYPE_NAME'),
			'a.`schedule`' => Text::_('COM_EVENTSCHEDULE_EVENTTYPES_SCHEDULE'),
		);
	}
