...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_EVENTSCHEDULE_TITLE_SECTIONS'), "generic");

		$toolbar = Toolbar::getInstance('toolbar');

		// Check if the form exists before showing the add/edit buttons
		$formPath = JPATH_COMPONENT_ADMINISTRATOR . '/src/View/Sections';
		...
		// Set sidebar action
		Sidebar::setAction('index.php?option=com_eventschedule&view=sections');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`section_name`' => Text::_('COM_EVENTSCHEDULE_SECTIONS_SECTION_NAME'),
			'a.`state`' => Text::_('JSTATUS'),
			'a.`container_ids`' => Text::_('COM_EVENTSCHEDULE_SECTIONS_CONTAINER_IDS'),
			'a.`schedule`' => Text::_('COM_EVENTSCHEDULE_SECTIONS_SCHEDULE'),
		);
	}
