 ...
 * @since    0.1b
 */
class com_eventscheduleInstallerScript extends InstallerScript
{
	/**
	 ...
	 * @var string
	 */
	protected $extension = 'Eventschedule';
	 ...
	 */
	public function addRootEventschedule()
	{
	    $db = Factory::getContainer()->get('DatabaseDriver');
